              ...
              <Grid container item spacing={1}>
                ...
                {questionUpdate && (
                  ...
                  <Grid id={question.id + 'Uid'} item xs={12}>
                    ...
                    Choice Update:<br/>
                    A<Checkbox id={question.id + 'input0'} checked={IsA} onChange={() => setIsA(!IsA)}/>
                    <Input id={question.id + 'input00'} placeholder={question.choice[0].choiceId} defaultValue = {question.choice[0].choiceId} onChange={(e) => setidA(e.target.value)} /><Input id={question.id + 'input000'} value = {choiceA} onChange={(e) => setChoiceA(e.target.value)} /><br/>
                    B<Checkbox id={question.id + 'input1'} checked={IsB} onChange={() => setIsB(!IsB)}/>
                    <Input id={question.id + 'input11'} placeholder={question.choice[1].choiceId} defaultValue = {question.choice[1].choiceId} onChange={(e) => setidB(e.target.value)} /><Input id={question.id + 'input111'} value = {choiceB} onChange={(e) => setChoiceB(e.target.value)} /><br/>
                    C<Checkbox id={question.id + 'input2'} checked={IsC} onChange={() => setIsC(!IsC)}/>
                    <Input id={question.id + 'input22'} placeholder={question.choice[2].choiceId} defaultValue = {question.choice[2].choiceId} onChange={(e) => setidC(e.target.value)} /><Input id={question.id + 'input222'} value = {choiceC} onChange={(e) => setChoiceC(e.target.value)} /><br/>
                    D<Checkbox id={question.id + 'input3'} checked={IsD} onChange={() => setIsD(!IsD)}/>
                    <Input id={question.id + 'input33'} placeholder={question.choice[3].choiceId} defaultValue = {question.choice[3].choiceId} onChange={(e) => setidD(e.target.value)} /><Input id={question.id + 'input333'} value = {choiceD} onChange={(e) => setChoiceD(e.target.value)} /><br/>
